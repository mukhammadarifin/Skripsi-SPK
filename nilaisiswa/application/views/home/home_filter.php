...
<html lang="en">
  ...
  <body>
    <!--Header-part-->
    <div id="header">
      <h2><a href="<?php echo site_url('Home') ?>">Sistem Pendukung Keputusan Pemilihan Bidang Studi Perguruan Tinggi</a></h2>
    </div>
      <?php
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        <h3>Grafik Data Nilai Siswa di Kelas <?php echo $nama_kelas ?></h3>
        <div class="row-fluid">
            ...
            <div class="widget-content">
              <div class="row-fluid">
                <div class="container-fluid">
                  ...
                  <canvas id="canvas2" width="1250" height="400"></canvas>
                  ...
                  <canvas id="canvas4" width="1250" height="400"></canvas>
                  <h5>Grafik Data Sejarah Indonesia</h5>
                  <canvas id="canvas6" width="1250" height="400"></canvas>
                  <h5>Grafik Data Seni Budaya di kelas</h5>
                  <canvas id="canvas8" width="1250" height="400"></canvas>
                  <h5>Grafik Data Pendidikan Jasmani, Olahraga, dan Kesehatan di kelas</h5>
                  <canvas id="canvas9" width="1250" height="400"></canvas>
                  <h5>Grafik Muatan Lokal Bahasa Daerah</h5>
                  <canvas id="canvas17" width="1250" height="400"></canvas>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="widget-content">
              <div class="row-fluid">
                <div class="container-fluid">
                  ...
                  <canvas id="canvas12" width="1250" height="400"></canvas>
                  <h5>Grafik Data Sistem Komputer</h5>
                  <canvas id="canvas13" width="1250" height="400"></canvas>
                  <h5>Grafik Data Komputer dan Jaringan Dasar</h5>
                  <canvas id="canvas14" width="1250" height="400"></canvas>
                  <h5>Grafik Data Pemrograman Dasar di kelas</h5>
                  <canvas id="canvas15" width="1250" height="400"></canvas>
                  <h5>Grafik Data Dasar Desain Grafis</h5>
                  <canvas id="canvas16" width="1250" height="400"></canvas>
                </div>
              </div>
            </div>
          </div>
