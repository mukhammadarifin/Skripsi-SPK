          ...
          <div class="widget-content">
            <div class="row-fluid">
              <div class="container-fluid">
                ...
                <canvas id="canvas" width="1400" height="380"></canvas>
                <h5>Grafik Data Pendidikan Agama Katholik dan Budi Pekerti</h5>
                <canvas id="canvas2" width="1400" height="380"></canvas>
                <h5>Grafik Data Pendidikan Pancasila dan Kewarganegaraan</h5>
                <canvas id="canvas3" width="1400" height="380"></canvas>
                <h5>Grafik Data Bahasa Indonesia</h5>
                <canvas id="canvas4" width="1400" height="380"></canvas>
                <h5>Grafik Data Sejarah Indonesia</h5>
                <canvas id="canvas6" width="1400" height="380"></canvas>
                <h5>Grafik Data Seni Budaya di kelas</h5>
                <canvas id="canvas8" width="1400" height="380"></canvas>
                <h5>Grafik Data Pendidikan Jasmani, Olahraga, dan Kesehatan di kelas</h5>
                <canvas id="canvas9" width="1400" height="380"></canvas>
                <h5>Grafik Muatan Lokal Bahasa Daerah</h5>
                <canvas id="canvas17" width="1400" height="380"></canvas>
              </div>
            </div>
          </div>
        </div>
