...
<body>
    <!--Header-part-->
    <div id="header">
        <h1><a href="<?php echo site_url('User') ?>">User</a></h1>
    </div>
    <!--close-Header-part-->
                    ...
                    <div class="widget-content">
                        <div class="row-fluid">
                            <div class="widget-content nopadding">
                                <?php echo form_open_multipart('User/form', array(
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <a class="btn btn-default" href="<?php echo base_url("excel/format_pengujian.xlsx"); ?>">Download Format</a>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="<?php echo site_url('User/pengujian') ?>" class="btn btn-primary" role="button" aria-pressed="true">Kembali</a>
                                </div>
                                <?php echo form_close(); ?>
                            </div>
                        </div>
                ...
                <div class="widget-box">
                    <div class="widget-content nopadding">
                        ...
                        if (isset($_POST['preview'])) { // Jika user menekan tombol Preview pada form 
                            ...
                            echo "<form method='post' action='" . base_url("index.php/User/import") . "'>";
                            ...
                            foreach ($sheet as $row) {
                                ...
                                if ($numrow > 1) {
                                    ...
                                    $cp_td = (!empty($cp)) ? "" : " style='background: #E07171;'";
                        ...
                        <?php
                            ...
                            echo "<a class='btn btn-danger pull-right' href='" . base_url("index.php/User/pengujian") . "'>Cancel</a>";
                            // }
