...
<body>
    <div id="loginbox">
        ...
        <div class="control-group normal_text">
            <h4>Pemilihan Bidang Studi Perguruan Tinggi<br>Halaman Login</h4>
        </div>
        ...
        <div class="form-actions">
            <a href="<?php echo site_url('Login/register') ?>" class="flip-link btn btn-inverse" id="to-recover">Register</a>
