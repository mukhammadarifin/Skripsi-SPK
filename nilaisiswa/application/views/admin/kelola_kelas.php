        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <a class="btn btn-default" href="<?php echo site_url('Admin/tambah_kelas') ?>">Tambah Kelas</a>
                ...
                <tbody>
                  ...
                  <?php foreach ($kelas as $key) { ?>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-primary" href="<?php echo site_url('Admin/edit_kelas/' . $key->id_kelas) ?>">Edit</a>
                        <a class="btn btn-danger" href="<?php echo site_url('Admin/delete_kelas/' . $key->id_kelas) ?>">Delete</a>
                      </td>
                      <?php $no++ ?>
                    </tr>
                  <?php } ?>
