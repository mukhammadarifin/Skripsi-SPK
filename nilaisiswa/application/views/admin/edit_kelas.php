            ...
            <div class="widget-content">
              <div class="row-fluid">
                <div class="widget-content nopadding">
                  <?php echo form_open('Admin/edit_kelas/'.$this->uri->segment(3),array(
                  ...
                  <?php foreach ($kelas as $key) { ?>
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" class="span11" name="nama_kelas" id="nama_kelas" value="<?php echo $key->nama_kelas ?>" placeholder="Kelas" required>
                      </div>
                    </div>
                  <?php } ?>
