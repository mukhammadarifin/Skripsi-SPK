      ...
      <ul>
        ...
        <li class="submenu"> <a href="#"><i class="icon icon-file"></i> <span>Manajemen Data</span></a>
          <ul>
            ...
            <li><a href="<?php echo site_url('Admin/kelola_kelas') ?>">Data Lokasi</a></li>
          </ul>
        </li>
      </ul>
    </div>
            ...
            <div class="widget-box">
              ...
              <div class="widget-content nopadding">
                ...
                <div class="form-actions">
                  ...
                  <a href="<?php echo site_url('Admin/kelola_user') ?>" class="btn btn-primary" role="button" aria-pressed="true">Kembali</a>
                </div>
