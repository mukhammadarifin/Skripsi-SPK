...
<div id="sidebar">
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-file"></i> <span>Manajemen Data</span></a>
      <ul>
        ...
        <li><a href="<?php echo site_url('Admin/kelola_nilai') ?>">Data Nilai Siswa</a></li>
      </ul>
    </li>
  </ul>
</div>
    ...
    <div class="span12">
      <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <?php echo form_open('Admin/tambah_kelas',array(
                      'class' => 'form-horizontal'
                  )); ?>
              <div class="control-group">
                <label class="control-label">Kelas :</label>
                <div class="controls">
                  <input type="text" class="span11" name="nama_kelas" id="nama_kelas" placeholder="Kelas" required>
                </div>
              </div>
              <div class="form-actions">
                <button type="submit" class="btn btn-success">Tambah</button>
                <a href="<?php echo site_url('Admin/kelola_kelas') ?>" class="btn btn-primary" role="button" aria-pressed="true">Kembali</a>
              </div>
            <?php echo form_close(); ?>
          </div>
        </div>
